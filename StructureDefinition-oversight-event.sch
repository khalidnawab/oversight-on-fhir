...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:AuditEvent">
      <sch:assert test="count(f:extension[@url = 'https://oversight-on-fhir.org/fhir/StructureDefinition/oversight-reason-ext']) &lt;= 1">extension with URL = 'https://oversight-on-fhir.org/fhir/StructureDefinition/oversight-reason-ext': maximum cardinality of 'extension' is 1</sch:assert>
