# Home - Oversight-on-FHIR Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://oversight-on-fhir.org/fhir/ImplementationGuide/oversight-on-fhir | *Version*:0.1.0 |
| Draft as of 2026-07-11 | *Computable Name*:OversightOnFHIR |
...
```json
{
  ...
  "id" : "oversight-on-fhir",
  "url" : "https://oversight-on-fhir.org/fhir/ImplementationGuide/oversight-on-fhir",
  "version" : "0.1.0",
  "name" : "OversightOnFHIR",
  "title" : "Oversight-on-FHIR Implementation Guide",
  "status" : "draft",
  ...
  "description" : "A draft IG representing the human oversight decision over agentic clinical AI output as first-class FHIR resources. Complementary to the HL7 AI Transparency on FHIR IG: that effort represents AI influence on clinical data; this profile represents the human decision (accept/edit/reject, with a structured reason) over agentic AI output.",
  "packageId" : "oversight-on-fhir",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://oversight-on-fhir.org/fhir/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/ai-authorship-provenance"
      },
      "name" : "AI Authorship Provenance",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/deescalation-guidance-response"
      },
      "name" : "De-escalation Guidance Response",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Provenance/prov-example"
      },
      "name" : "Example AI Authorship Provenance",
      "exampleCanonical" : "https://oversight-on-fhir.org/fhir/StructureDefinition/ai-authorship-provenance"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "name" : "Example De-escalation Guidance Response",
      "exampleCanonical" : "https://oversight-on-fhir.org/fhir/StructureDefinition/deescalation-guidance-response"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "AuditEvent/escalation-example"
      },
      "name" : "Example Oversight Event — Escalation (allergy_to_candidate)",
      "exampleCanonical" : "https://oversight-on-fhir.org/fhir/StructureDefinition/oversight-event"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "AuditEvent/oversight-reject-example"
      },
      "name" : "Example Oversight Event — Reject (data-vintage)",
      "exampleCanonical" : "https://oversight-on-fhir.org/fhir/StructureDefinition/oversight-event"
    },
    {
      "extension" : [{
      ...
      "name" : "Example Patient (synthetic)",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "name" : "Example Practitioner (synthetic)",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "CodeSystem/high-risk-rule"
      },
      "name" : "High-Risk Routing Rule",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/oversight-disposition"
      },
      "name" : "Oversight Disposition",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/oversight-disposition-vs"
      },
      "name" : "Oversight Disposition Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/oversight-event"
      },
      "name" : "Oversight Event",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/oversight-event-type"
      },
      "name" : "Oversight Event Type",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/oversight-event-type-vs"
      },
      "name" : "Oversight Event Type Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/oversight-reason"
      },
      "name" : "Oversight Override Reason",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/oversight-reason-vs"
      },
      "name" : "Oversight Override Reason Value Set",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/oversight-reason-ext"
      },
      "name" : "Oversight Reason Extension",
    ...
    },
    {
      ...
      "name" : "Oversight-on-FHIR AI Device",
      "exampleBoolean" : true
    }],
    "page" : {
      "extension" : [{
